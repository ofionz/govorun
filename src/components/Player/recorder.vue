...
<template>
  <div class="ar">
    ...
    <div class="ar-content" :class="{'ar__blur': isUploading}">
      ...
      <div class="ar-recorder__records-limit" v-if="attempts">Попыток: {{attemptsLeft}}/{{attempts}}</div>
      ...
      <div class="ar-records">
        <div
          ...
          @click="choiceRecord(record)">
            ...
            <div class="ar__text">Новая запись {{idx + 1}}</div>
  ...
  export default {
    ...
    methods: {
     ...
     //   this.recordList = this.recorder.recordList();
        ...
        this.recordList = [];
        this.recordList.push(this.recorder.lastRecord());
